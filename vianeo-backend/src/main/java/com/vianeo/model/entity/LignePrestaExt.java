...
@Entity
@Table(name = "ligne_presta_ext", schema = "vianeo")
public class LignePrestaExt {
    ...
    // Constructeurs
    public LignePrestaExt() {}
    
    public LignePrestaExt(Rapport rapport, Article article, Fournisseur fournisseur, 
