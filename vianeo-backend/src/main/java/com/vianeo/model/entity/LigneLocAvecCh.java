...
@Entity
@Table(name = "ligne_loc_avec_ch", schema = "vianeo")
public class LigneLocAvecCh {
    ...
    // Constructeurs
    public LigneLocAvecCh() {}
    
    public LigneLocAvecCh(Rapport rapport, Article article, Fournisseur fournisseur, 
