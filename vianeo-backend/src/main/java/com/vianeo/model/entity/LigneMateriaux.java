...
@Entity
@Table(name = "ligne_materiaux", schema = "vianeo")
public class LigneMateriaux {
    ...
    // Constructeurs
    public LigneMateriaux() {}
    
    public LigneMateriaux(Rapport rapport, Article article, Fournisseur fournisseur, 
