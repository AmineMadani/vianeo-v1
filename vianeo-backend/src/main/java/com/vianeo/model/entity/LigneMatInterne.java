...
@Entity
@Table(name = "ligne_mat_interne", schema = "vianeo")
public class LigneMatInterne {
    ...
    // Constructeurs
    public LigneMatInterne() {}
    
    public LigneMatInterne(Rapport rapport, Article article, BigDecimal quantite, BigDecimal pu) {
