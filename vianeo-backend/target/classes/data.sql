...
VALUES
  (1, 1, 'admin', 'admin@vianeo.test',
   '$2a$12$2CFhXJ6pWgOtXIm3ByeLEeKqL8hc/hwHQRAOO6JW9cCDe1ffsDs56',
   'ROLE_ADMIN', TRUE, now())
ON CONFLICT (id) DO NOTHING;
...
VALUES
  (1, 'CH-0001', 'Chantier Test', '1 rue du Test', 'Lille', '59000', 2, TRUE, 1),
  (2, 'CH-0002', 'Chantier Sept', '13 rue du Test', 'Montpellier', '34000', 2, TRUE, 1) -- id=2 et responsable_id=2
ON CONFLICT (id) DO NOTHING;
...
-- ===== RAPPORT (DRAFT) =====
-- ⚠️ 'auteur_id' doit exister : ici 2 (Chef Bob)
